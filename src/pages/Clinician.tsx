...
interface Booking {
    ...
    updatedAt: Date;
    clinician?: {
        // Optional nested clinician data
        name: string;
    };
}
...
const Clinician = () => {
    ...
    return (
        <div className="space-y-4">
            ...
            <BookingListTable data={data} onView={handleView} />
            {
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center lg:gap-40 gap-20 py-4 border-b border-gray-200">
                                    ...
                                    <div className="text-right max-w-md">{modalData.message}</div>
                                </div>
                                ...
                                <div className="flex justify-between items-center lg:gap-40 gap-20 py-4 border-b border-gray-200">
                                    ...
                                    <div>
                                        {format(modalData.startTime, "h:mm a")} -{" "}
                                        {format(modalData.endTime, "h:mm a")}
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center lg:gap-40 gap-20 py-4 border-b border-gray-200">
                                    ...
                                    <div>
                                        {calculateDuration(modalData.startTime, modalData.endTime)}
                                    </div>
                                </div>

...
const BlogDetails = () => {
    ...
    return (
        <div>
            <HeroHeader breadcrumbs={breadcrumbs} title={dummyBlogData.title} imageUrl={"https://img.freepik.com/free-photo/lone-yacht-with-super-full-moon-ai-generated-image_511042-1754.jpg?uid=R110243807&ga=GA1.1.1088808881.1737022066&semt=ais_hybrid"} />

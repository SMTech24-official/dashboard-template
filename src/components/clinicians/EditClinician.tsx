...
const EditClinician = ({
  ...
  editingClinician: Clinician | null;
      ...
      <Form form={form} layout="vertical">
        <div className="flex gap-6 mb-6">
          ...
          <div className="w-3/4 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Form.Item name="portfolioLink" label="Portfolio Link">
                <Input />
              </Form.Item>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Form.Item name="serviceTypes" label="Service Types">
            <Select mode="multiple">
              {["Individual", "Couples", "Family", "Group", "Workshops"].map(
                (type) => (
        ...
        <Form.Item
          name="descriptions"
          rules={[
            { required: true, message: "Please enter a professional summary" },
          ]}
        >
          <TextArea
            rows={4}
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please enter detailed background information",
            },
          ]}
        >
          <TextArea

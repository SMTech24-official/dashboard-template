                    ...
                    >
                        {link.subItems.map((subItem) => (
                            <Link
                                key={subItem.name}
                                to={subItem.href}
                                className={`flex items-center gap-3 px-3 py-2 rounded-md ${isActive(subItem.href)
                                    ? "bg-primary text-white"
                                    : "hover:bg-primary/10 hover:text-primary"
                                    }`}
                            >
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <nav className="flex-1 p-4">
                <div className="space-y-1">
                    {navLink.map((link) => renderNavLink(link))}
                </div>
            </nav>
            ...
            <div className="mt-auto p-4 space-y-1">
                ...
                <div
                    ...
                    className="flex items-center gap-3 px-3 py-3 rounded-md cursor-pointer hover:bg-[#8B4C84]/10"
                >
